...
const ResumePage = () => {
  ...
  const fetchCareers = () => {
    axios
      .get("http://localhost:5000/api/resumes/career/careerIds")
      .then((response) => {
  ...
  const handleSelectCareer = (careerId) => {
    ...
    axios
      .get(`http://localhost:5000/api/resumes/${careerId}`)
      .then((response) => {
  ...
  const handleAddNewCareer = () => {
    if (newCareer.trim() !== "") {
      ...
      axios
        .post("http://localhost:5000/api/resumes/process", careerObject)
        .then((response) => {
  ...
  const handleDeleteCareer = (careerId) => {
    axios
      .delete(`http://localhost:5000/api/resumes/delete/${careerId}`)
      .then((response) => {
